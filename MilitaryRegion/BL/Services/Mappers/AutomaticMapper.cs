...
{
    public class AutomaticMapper : IModelMapper<MilitaryBaseWeaponry, WeaponryViewModel>
    {
        public WeaponryViewModel MapModel(MilitaryBaseWeaponry baseModel, IUnitOfWork db)
        {
            ...
            var automatic = db.Automatics.Find(a => a.WeaponryId == weaponry.Id).FirstOrDefault();
            ...
            var model = new WeaponryViewModel
            {
                ...
                FiringSpeed = automatic.FiringSpeed
