...
{
    public class BMPMapper : IModelMapper<MilitaryBaseMachinery, TechnicViewModel>
    {
        public TechnicViewModel MapModel(MilitaryBaseMachinery baseModel, IUnitOfWork db)
        {
            ...
            var bmp = db.IFVs.Find(i => i.MachineryId == machinery.Id).FirstOrDefault();
