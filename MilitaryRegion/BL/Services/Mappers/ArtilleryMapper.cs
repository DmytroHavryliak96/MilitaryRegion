...
{
    public class ArtilleryMapper : IModelMapper<MilitaryBaseWeaponry, WeaponryViewModel>
    {
        public WeaponryViewModel MapModel(MilitaryBaseWeaponry baseModel, IUnitOfWork db)
        {
            ...
            var art = db.Artilleries.Find(a => a.WeaponryId == weaponry.Id).FirstOrDefault();
            ...
            var model = new WeaponryViewModel
            {
                ...
                ShootingRange = art.ShootingRange
