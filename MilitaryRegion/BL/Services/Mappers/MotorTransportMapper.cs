...
{
    public class MotorTransportMapper : IModelMapper<MilitaryBaseMachinery, TechnicViewModel>
    {
        public TechnicViewModel MapModel(MilitaryBaseMachinery baseModel, IUnitOfWork db)
        {
            ...
            var motor = db.MotorTransports.Find(i => i.MachineryId == machinery.Id).FirstOrDefault();
